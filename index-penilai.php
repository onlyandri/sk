...
<head>
  ...
  <title>SPK Evaluasi Kinerja Karyawan</title>
...
$subkriteria = mysqli_query($koneksi, "SELECT * FROM subkriteria");
$subkriteria = mysqli_num_rows($subkriteria);
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-danger shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Sub Kriteria</div>
