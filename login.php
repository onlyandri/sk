            ...
            <!-- Nested Row within Card Body -->
                ...
                <div class="p-5">
                  <div class="text-center">
                    <center><img src="img/logo.png" width="80%"></center>
                    <h1 class="h4 text-gray-900 mb-4">Selamat Datang!</h1>
                  </div>
                  <form class="user" action="login-proses.php" method="post">
                    <div class="form-group">
                      <input type="text" name="email" class="form-control form-control-user" required="required" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Username...">
                    </div>
                    <div class="form-group">
