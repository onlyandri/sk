...
$query_edit = mysqli_query($koneksi,"SELECT * FROM nilai n  JOIN nilai_detail d ON  n.id_nilai=d.id_nilai WHERE d.id_nilai=$id");
...
?>
       ...
       <div class="form-group">
        <label>NIK</label>
        <input readonly="" name="nik" class="form-control" value="<?php echo $data['nik']; ?>">      
        </div>
