  ...
  <div id="content">
    ...
    <div class="container-fluid">
      ...
      <div class="modal-content">
        ...
        <!-- body modal -->
        <div class="card-body">
          <form action="proses-tambah-penilaian.php" method="get">
            NIK :
          </select>
          <select name="nik" id="nik" class="form-control" required="required">
            ...
            while($d=mysqli_fetch_assoc($s)){
              ...
              $q = mysqli_query($koneksi,"SELECT * from karyawan k join nilai n on k.nik = n.nik where k.nik = $nik");
          ...
          Jabatan :
          <input type="text" class="form-control" required="required" id="jabatan" name="jabatan" readonly>

          Tanggal :
          <input type="date" class="form-control" required="required" name="tgl_nilai">
          <br>
          <table class="table">
            <thead>
              <tr>
              ...
              while ($data = mysqli_fetch_assoc($sql)) {
               ...
               <tr>
                ...
                <td>
                  ...
                  <input type="number" min="1" max="5" required="required" placeholder="Masukkan Nilai 1-5" class="form-control" name="<?=$data['kode_subkriteria']; ?>"/>
                </td>
              </tr>
